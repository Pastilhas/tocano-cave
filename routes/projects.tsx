...
export default function Home() {
  return (
    <>
      ...
      <Header />
      <div class="p-8 mx-auto my-10 max-w-screen-md flex rounded-lg shadow bg-gray-100">
        <div class="mr-10">
          <img
            src="/toucan.png"
          ...
          <div class="flex">
            ...
            <div class="h-5 w-5"></div>
            <a href="https://github.com/Pastilhas">
              <BrandGithub class="h-5 w-5 mr-3" />
            </a>
            <a href="https://www.linkedin.com/in/joaopcampos0/">
      ...
      <div class="p-10 mx-auto my-5 max-w-screen-md rounded-lg shadow bg-gray-100">
        ...
        <details id="inegi">
          <summary class="flex items-center">
            <ArrowDown class="h-5 w-5 mr-3 pb-1 open:bg-gray-800" />
            <h2 class="font-bold mb-1 mr-3">INEGI</h2>
            <h2 class="font-bold mb-1 mr-3">Software Developer</h2>
            <h2 class="font-bold mb-1 mr-3">09.2021 – Now</h2>
          </summary>
          <div>
            <p>
        ...
        <details id="biztapp">
          <summary class="flex items-center">
            <ArrowDown class="h-5 w-5 mr-3 pb-1 open:bg-gray-800" />
            <h2 class="font-bold mb-1 mr-3">BizTapp Gmbh.</h2>
            <h2 class="font-bold mb-1 mr-3">Software Developer</h2>
            <h2 class="font-bold mb-1 mr-3">03.2022 – 09.2022</h2>
          </summary>
          <div>
            <p>
        ...
        <details id="midnera">
          <summary class="flex items-center">
            <ArrowDown class="h-5 w-5 mr-3 pb-1" />
            <h2 class="font-bold mb-1 mr-3">Mindera Gaming</h2>
            <h2 class="font-bold mb-1 mr-3">Game Developer</h2>
            <h2 class="font-bold mb-1 mr-3">07.2019 – 08.2019</h2>
          </summary>
          <div>
            <p>
